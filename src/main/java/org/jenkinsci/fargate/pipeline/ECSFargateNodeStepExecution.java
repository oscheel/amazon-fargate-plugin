...
public class ECSFargateNodeStepExecution extends AbstractStepExecutionImpl implements Serializable{


    private final ECSFargateNodeStep step;
    ...
    public static final class PlaceholderTask implements ContinuedTask, Serializable, AccessControlled {
        ...
        /** Initially set to {@link ECSFargateNodeStep#getLabel}, if any; later switched to actual self-label when block runs. */
    ...
    private static final Logger LOGGER = Logger.getLogger(ECSFargateNodeStepExecution.class.getName());
}